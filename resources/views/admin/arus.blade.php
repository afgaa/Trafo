                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h5 class="card-title text-primary">Monitoring Arus</h5>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="dropdown">
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <a href='{{ route('cetak_arus') }}'
                                                        class="btn btn-sm btn-outline-primary">Cetak
                                                        Data</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <p class="mt-2"> Monitoring Arus Sebelumnya</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="row d-flex justify-content-right">
                                    <div class="col-sm-8">
                                        <h5 class="card-title text-primary">Arus R</h5>
                                    </div>
                                    <div class="col-sm-4">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="row d-flex justify-content-right">
                                    <div class="col-sm-8">
                                        <h5 class="card-title text-primary">Arus S</h5>
                                    </div>
                                    <div class="col-sm-4">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="row d-flex justify-content-right">
                                    <div class="col-sm-8">
                                        <h5 class="card-title text-primary">Arus T</h5>
                                    </div>
                                    <div class="col-sm-4">
...
@section('script')
    ...
    <script>
        ...
        var MQTTsubTopicarusR = '{{ $pilih_trafo->arus->topic_name_r }}';
        var MQTTsubTopicarusS = '{{ $pilih_trafo->arus->topic_name_s }}';
        var MQTTsubTopicarusT = '{{ $pilih_trafo->arus->topic_name_t }}';
        ...
        const periodeChartTesEl = document.querySelector('#periodeChartTes'),
            periodeChartTesConfig = {
                ...
                yaxis: [{
                        ...
                        max: 100, // Nilai maksimum dari sumbu y
                    ...
                    },
                    {
                        ...
                        max: 100, // Nilai maksimum dari sumbu y untuk sumbu y yang berlawanan
